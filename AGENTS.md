...
`web-fifo` is a development-only Rust reverse proxy. Keep the runtime as one
...
developer deliberately visits the `web-fifo proxy` address or adds the documented
